  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col flex-1 px-20 mt-20 space-y-20 w-full lg:w-3/5 selection:bg-black selection:text-white">
        <header className="font-roboto-mono text-left flex flex-col space-y-5">
        ...
        <div className="w-full my-5">
          <div className=" font-light space-y-5">
            ...
            <p>
              ...
              <span className="font-bold">full stack developer and graphic designer</span>, and got his BSc degree in{" "}
          ...
          <div className="flex flex-col space-y-5 lg:flex-row w-full lg:space-y-0 justify-between">
            <div className="flex items-center">
              ...
              <a className="text-blue-500 hover:underline p-1" href="https://github.com/itaikeren/" target="_blank">
                @itaikeren
              </a>
            </div>
            <div className="flex items-center">
              ...
              <a className="text-blue-500 hover:underline p-1" href="https://twitter.com/itai_keren/" target="_blank">
                @itai_keren
              </a>
            </div>
            <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <a className="text-blue-500 hover:underline p-1" href="https://dribbble.com/itaikeren/" target="_blank">
                @itaikeren
              </a>
            </div>
          </div>
